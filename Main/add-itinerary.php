...
<body>
    ...
    <div class="search-container">
        ...
        <form autocomplete="off" id="itinerary-form" method="POST" action="Hotels/handle_itinerary.php">
            <div class="autocomplete"><!-- Form fields -->
...
// Make a GET request to the API using Fetch API
fetch("https://restcountries.com/v3.1/all")
    ...
    .then(countries => {
        // Extract and create an array of country names
        const countryNames = countries.map(country => country.name.common);
        console.log(countryNames);
        // Initiate the autocomplete function on the "myInput" element
        autocomplete(document.getElementById("country"), countryNames);
